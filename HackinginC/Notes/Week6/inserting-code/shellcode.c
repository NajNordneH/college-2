...
int main(int argc, char *argv[]) {
  ...
  if (argc == 1 || argc > 3 ||
      (!strncmp(argv[1], "list", 5) && !strncmp(argv[1], "shell", 5))) {
    ...
    fprintf(stderr, "The optional argument nopbytes specifies the number of "
                    "NOP instructions to prefix the code with (default 0)\n");
